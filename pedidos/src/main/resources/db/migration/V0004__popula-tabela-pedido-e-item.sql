-- Pedidos
INSERT INTO Pedido (id, dataHora, status, nomeCliente, cpfCliente, celularCliente, enderecoCliente, pagamentoId)
VALUES
(1, '2024-10-13 12:30:00', 'REALIZADO', 'Chaves', '123.456.789-00', '(11) 91234-5678', 'Vila 8, Barril do Chaves', 1),
(2, '2024-10-13 13:00:00', 'REALIZADO', 'Seu Madruga', '234.567.890-11', '(11) 92345-6789', 'Vila 8, Casa 72', 2),
(3, '2024-10-13 13:15:00', 'REALIZADO', 'Seu Madroga, Primo do Seu Madruga', '345.678.901-22', '(11) 93456-7890', 'Vila 8, Casa 14', 3),
(4, '2024-10-13 14:00:00', 'REALIZADO', 'Quico', '456.789.012-33', '(11) 94567-8901', 'Vila 8, Casa 14', 4),
(5, '2024-10-13 14:30:00', 'REALIZADO', 'Professor Girafales', '567.890.123-44', '(11) 95678-9012', 'Vila 8, Sala dos Professores', 5),
(6, '2024-10-13 15:00:00', 'REALIZADO', 'Dona Clotilde', '678.901.234-55', '(11) 96789-0123', 'Vila 8, Casa 71', 6),
(7, '2024-10-13 15:15:00', 'REALIZADO', 'Seu Barriga', '789.012.345-66', '(11) 97890-1234', 'Vila 8, Casa 20', 7),
(8, '2024-10-13 15:30:00', 'REALIZADO', 'Nhonho', '890.123.456-77', '(11) 98901-2345', 'Vila 8, Casa 20', 8),
(9, '2024-10-13 16:00:00', 'REALIZADO', 'Paty', '901.234.567-88', '(11) 99012-3456', 'Vila 8, Casa 15', 9),
(10, '2024-10-13 16:30:00', 'REALIZADO', 'Godinez', '012.345.678-99', '(11) 90123-4567', 'Vila 8, Casa 13', 10),
(11, '2024-10-13 17:00:00', 'REALIZADO', 'Dona Neves', '123.678.901-00', '(11) 91123-4567', 'Vila 8, Casa 72', 11),
(12, '2024-10-13 17:15:00', 'REALIZADO', 'Pópis', '234.789.012-11', '(11) 92234-5678', 'Vila 8, Casa 14', 12),
(13, '2024-10-13 17:30:00', 'REALIZADO', 'Jaiminho', '345.890.123-22', '(11) 93345-6789', 'Correios, Vila 8', 13),
(14, '2024-10-13 18:00:00', 'REALIZADO', 'Chiquinha', '456.901.234-33', '(11) 94456-7890', 'Vila 8, Casa 73', 14),
(15, '2024-10-13 18:30:00', 'REALIZADO', 'Malicha', '567.012.345-44', '(11) 95567-8901', 'Vila 8, Casa 71', 15);
...
-- Pedido do Seu Madroga, Primo do Seu Madruga
INSERT INTO ItemPedido (id, quantidade, precoUnitario, observacao, pedido_id, itemCardapio_id)
VALUES
